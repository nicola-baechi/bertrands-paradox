package startscreen.controller;
...
public class StartScreenController implements Initializable {
    ...
    public void handleButton50(ActionEvent event) throws IOException {
        Parent radialPointMethod = FXMLLoader.load(getClass().getResource("../../radialpointmethod/view/RadialPointView.fxml"));
    ...
    public void handleButton33(ActionEvent event) throws IOException {
        Parent endPointMethod = FXMLLoader.load(getClass().getResource("../../endpointmethod/view/EndPointView.fxml"));
        Stage oldStage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    ...
    public void handleButton25(ActionEvent event) throws IOException {
        Parent midPointMethod = FXMLLoader.load(getClass().getResource("../../midpointmethod/view/MidPointView.fxml"));
        Stage oldStage = (Stage) ((Node) event.getSource()).getScene().getWindow();
